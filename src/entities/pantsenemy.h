...
public:
    ...
    // 重写 takeDamage 以确保死亡时清理 spinning 资源
...
private:
    ...
    QTimer *m_spinningCooldownTimer;        // 技能冷却定时器（20秒）
    ...
    static constexpr double SPINNING_SPEED_MULTIPLIER = 1.5; // 技能期间移速倍率
