      ...
      m_facingRight(true)
{
    ...
    setPreferredDistance(KEEP_DISTANCE);
...
XukeProjectile::XukeProjectile(BulletType type, int baseDamage, QPointF pos, const QPixmap &pic,
