...
void ZhuhaoEnemy::initializeAtRandomEdge()
{
    ...
    {
    case 0: // 上边缘
        centerX = QRandomGenerator::global()->bounded(static_cast<int>(MAP_LEFT + 50), static_cast<int>(MAP_RIGHT - 50));
        centerY = MAP_TOP;
        m_currentEdge = 0;
        break;
    case 1: // 右边缘
        centerX = MAP_RIGHT;
        centerY = QRandomGenerator::global()->bounded(static_cast<int>(MAP_TOP + 50), static_cast<int>(MAP_BOTTOM - 50));
        m_currentEdge = 1;
        break;
    case 2: // 下边缘
        centerX = QRandomGenerator::global()->bounded(static_cast<int>(MAP_LEFT + 50), static_cast<int>(MAP_RIGHT - 50));
